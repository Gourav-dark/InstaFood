...
@dso_cache = dso_local local_unnamed_addr global [1188 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 23253790, ; hash 0x162d31e, from name: InstaFood.PhoneApp
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 169859441, ; hash 0xa1fd971, from name: libaot-ChilkatDotNet46
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 226852882, ; hash 0xd858012, from name: libaot-InstaFood.DataAccess
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 304808680, ; hash 0x122b02e8, from name: libaot-InstaFood.Shared
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 416013368, ; hash 0x18cbdc38, from name: InstaFood.Shared.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-InstaFood.Shared.dll.so
		ptr null; void* handle (0x0)
	}, ; 116
	...
	%struct.DSOCacheEntry {
		i64 420522062, ; hash 0x1910a84e, from name: aot-InstaFood.DataAccess.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-InstaFood.DataAccess.dll.so
		ptr null; void* handle (0x0)
	}, ; 118
	...
	%struct.DSOCacheEntry {
		i64 589323872, ; hash 0x23205e60, from name: libaot-InstaFood.PhoneApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-InstaFood.PhoneApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 157
	...
	%struct.DSOCacheEntry {
		i64 1176545702, ; hash 0x4620a9a6, from name: aot-ChilkatDotNet46
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.13_name, ; name: libaot-ChilkatDotNet46.dll.so
		ptr null; void* handle (0x0)
	}, ; 302
	...
	%struct.DSOCacheEntry {
		i64 1281094864, ; hash 0x4c5bf4d0, from name: InstaFood.DataAccess.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-InstaFood.DataAccess.dll.so
		ptr null; void* handle (0x0)
	}, ; 333
	...
	%struct.DSOCacheEntry {
		i64 1360319550, ; hash 0x5114d43e, from name: aot-InstaFood.Shared.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-InstaFood.Shared.dll.so
		ptr null; void* handle (0x0)
	}, ; 352
	...
	%struct.DSOCacheEntry {
		i64 1495505827, ; hash 0x59239ba3, from name: libaot-InstaFood.DataAccess.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-InstaFood.DataAccess.dll.so
		ptr null; void* handle (0x0)
	}, ; 406
	...
	%struct.DSOCacheEntry {
		i64 1731107000, ; hash 0x672e98b8, from name: aot-ChilkatDotNet46.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.13_name, ; name: libaot-ChilkatDotNet46.dll.so
		ptr null; void* handle (0x0)
	}, ; 462
	...
	%struct.DSOCacheEntry {
		i64 1800714753, ; hash 0x6b54ba01, from name: InstaFood.Shared
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-InstaFood.Shared.dll.so
		ptr null; void* handle (0x0)
	}, ; 486
	...
	%struct.DSOCacheEntry {
		i64 1914132857, ; hash 0x72175979, from name: libaot-InstaFood.PhoneApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-InstaFood.PhoneApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 517
	...
	%struct.DSOCacheEntry {
		i64 2141440466, ; hash 0x7fa3c9d2, from name: aot-InstaFood.Shared
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-InstaFood.Shared.dll.so
		ptr null; void* handle (0x0)
	}, ; 579
	...
	%struct.DSOCacheEntry {
		i64 2209263257, ; hash 0x83aeae99, from name: libaot-ChilkatDotNet46.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.13_name, ; name: libaot-ChilkatDotNet46.dll.so
		ptr null; void* handle (0x0)
	}, ; 598
	...
	%struct.DSOCacheEntry {
		i64 2265766578, ; hash 0x870cdab2, from name: aot-InstaFood.PhoneApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-InstaFood.PhoneApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 618
	...
	%struct.DSOCacheEntry {
		i64 2941261169, ; hash 0xaf501571, from name: aot-InstaFood.PhoneApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-InstaFood.PhoneApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 814
	...
	%struct.DSOCacheEntry {
		i64 2966358590, ; hash 0xb0cf0a3e, from name: InstaFood.PhoneApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-InstaFood.PhoneApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 822
	...
	%struct.DSOCacheEntry {
		i64 3419286801, ; hash 0xcbce2d11, from name: ChilkatDotNet46
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.13_name, ; name: libaot-ChilkatDotNet46.dll.so
		ptr null; void* handle (0x0)
	}, ; 954
	...
	%struct.DSOCacheEntry {
		i64 3962306622, ; hash 0xec2c003e, from name: InstaFood.DataAccess
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-InstaFood.DataAccess.dll.so
		ptr null; void* handle (0x0)
	}, ; 1097
	...
	%struct.DSOCacheEntry {
		i64 4075518688, ; hash 0xf2eb7ae0, from name: ChilkatDotNet46.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.13_name, ; name: libaot-ChilkatDotNet46.dll.so
		ptr null; void* handle (0x0)
	}, ; 1122
	...
	%struct.DSOCacheEntry {
		i64 4127562050, ; hash 0xf6059942, from name: libaot-InstaFood.Shared.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-InstaFood.Shared.dll.so
		ptr null; void* handle (0x0)
	}, ; 1135
	...
	%struct.DSOCacheEntry {
		i64 4248870487, ; hash 0xfd409e57, from name: aot-InstaFood.DataAccess
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-InstaFood.DataAccess.dll.so
		ptr null; void* handle (0x0)
	}, ; 1167
...
@assembly_store_bundled_assemblies = dso_local local_unnamed_addr global [228 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 4
