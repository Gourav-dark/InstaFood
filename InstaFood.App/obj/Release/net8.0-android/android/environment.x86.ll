...
@dso_cache = dso_local local_unnamed_addr global [1068 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 1738407404, ; hash 0x679dfdec, from name: libaot-InstaFood.App.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 2266594518, ; hash 0x87197cd6, from name: InstaFood.App
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-InstaFood.App.dll.so
		ptr null; void* handle (0x0)
	}, ; 549
	...
	%struct.DSOCacheEntry {
		i64 2630886068, ; hash 0x9cd022b4, from name: aot-InstaFood.App
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-InstaFood.App.dll.so
		ptr null; void* handle (0x0)
	}, ; 646
	...
	%struct.DSOCacheEntry {
		i64 3024194584, ; hash 0xb4418c18, from name: InstaFood.App.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-InstaFood.App.dll.so
		ptr null; void* handle (0x0)
	}, ; 755
	...
	%struct.DSOCacheEntry {
		i64 3091655701, ; hash 0xb846ec15, from name: aot-InstaFood.App.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-InstaFood.App.dll.so
		ptr null; void* handle (0x0)
	}, ; 779
	...
	%struct.DSOCacheEntry {
		i64 3839015267, ; hash 0xe4d2b963, from name: libaot-InstaFood.App
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-InstaFood.App.dll.so
		ptr null; void* handle (0x0)
	}, ; 952
...
@assembly_store_bundled_assemblies = dso_local local_unnamed_addr global [208 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 4
